...
public class UploadConfirmationResiTask extends AsyncTask<Object, Void, String> {
    ...
    protected String doInBackground(Object... params) {
        ...
        String noresi = (String) params[9];
        String alamat_pengiriman = (String) params[10];
        String total_barang = (String) params[11];
        Bitmap gambarResi = (Bitmap) params[12];
